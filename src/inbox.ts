...
// localhost). When the app is served over plain http (e.g. from a server via
// its IP/hostname) it is undefined, so fall back to a getRandomValues-based
// (or Math.random) implementation.
